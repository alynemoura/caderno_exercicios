...
print("Formata (shape) do vetor:", vetor.shape)
...
# Verificando atributos
print("\nFormato (shape) da amtriz:", matriz.shape)
...
# Array 4D com valores sequencia is de 0 a 110 organizado em 2x3x4x5 (2 blocos, 3 "planos", 4 linhas, 5 colunas)
